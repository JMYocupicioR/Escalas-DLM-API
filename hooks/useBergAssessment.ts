...
import { questions, scoreInterpretation } from '@/data/berg';
...
export const useBergAssessment = () => {
  ...
  const completeAssessment = useCallback((): BergResults => {
