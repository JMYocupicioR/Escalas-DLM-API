...
export const puntosMotoresData = {
  // CABEZA Y CARA - Músculos nuevos agregados
  "Frontal (Frontalis)": "Región: Cabeza y Cara. Línea de Referencia: Línea vertical desde el borde medial de la ceja o línea mediopupilar. Localización: Múltiples puntos distribuidos. Inyecciones a 1.5-2.5 cm por encima del reborde orbitario superior para evitar ptosis. Un patrón común es de 4 puntos a lo largo de las arrugas horizontales. Guía visual: Ilustración de la frente mostrando el músculo frontal. Se marcan el reborde orbitario superior y la línea mediopupilar. Varios puntos de inyección (X) se distribuyen en una V invertida o en filas horizontales en la parte superior de la frente.",
  "Corrugador Superciliar": "Región: Cabeza y Cara. Punto de Referencia Palpable: Vientre muscular al fruncir el ceño. Localización: 1.5 cm (un dedo de ancho) por encima del borde orbitario superomedial. Un segundo punto puede estar en la intersección de la línea mediopupilar y el arco superciliar. Inyección profunda medialmente, superficial lateralmente. Guía visual: Imagen de la región glabelar. Se marca el reborde orbitario y la línea mediopupilar. Un punto (X) se sitúa sobre el extremo medial de la ceja y otro opcionalmente más lateral.",
  "Prócer (Procerus)": "Región: Cabeza y Cara. Punto de Referencia: Línea media, entre los puntos de inyección del corrugador. Localización: Punto único en la línea media, 1.5 cm por encima de los rebordes orbitarios mediales. Inyección superficial. Guía visual: Imagen de la raíz nasal. Se marca un único punto (X) en la línea media, justo entre y ligeramente por encima de las cejas.",
  "Orbicular de los Ojos": "Región: Cabeza y Cara. Localización: Inervación difusa. Para 'patas de gallo', múltiples inyecciones intradérmicas a 1 cm del reborde orbitario lateral. Puntos motores electrofisiológicos en el extremo lateral del pliegue palpebral superior y el extremo medial del pliegue palpebral inferior. Guía visual: Ilustración de la región periorbitaria. Se marcan varios puntos (X) en forma de abanico alrededor del canto lateral del ojo. Se señalan puntos adicionales en el pliegue del párpado superior e inferior.",
  "Mentoniano (Mentalis)": "Región: Cabeza y Cara. Punto de Referencia: Pogonion (punto más anterior del mentón). Localización: 0.5 cm lateral al pogonion, a cada lado. Se recomienda una inyección profunda (vientre muscular) y una superficial (inserción dérmica) en el mismo sitio. Guía visual: Imagen del mentón. Se marca el pogonion en la línea media. Dos puntos (X) se sitúan simétricamente a 0.5 cm a cada lado del pogonion.",
  "Masetero (Masseter)": "Región: Cabeza y Cara. Punto de Referencia Palpable: Vientre muscular al apretar los dientes. Localización: PM1: Punto medio de la línea entre el proceso maxilar del cigoma y el ángulo mandibular. PM2: Punto medio de la línea entre el hueso cigomático y el lóbulo de la oreja. Guía visual: Ilustración de la mejilla mostrando el músculo masetero. Se trazan las líneas de referencia y se marcan dos puntos (X) en el vientre muscular inferior.",
  "Temporal (Temporalis)": "Región: Cabeza y Cara. Línea de Referencia (AB): Desde el trago (A) hasta el canto lateral del ojo (B). Localización: PM1: Rotar línea AB 30° hacia arriba (centro A). PM2: Rotar línea AB 30° hacia arriba (centro B). PM3: En el extremo de una línea vertical desde el punto medio de AB, con longitud igual a AB. Guía visual: Imagen de la región temporal. Se dibuja la línea AB. Se marcan tres puntos (X) en forma de abanico por encima del arco cigomático, correspondiendo a las descripciones.",

  // CUELLO - Músculos nuevos agregados
  "Esternocleidomastoideo (ECM)": "Región: Cuello. Línea de Referencia: Desde la apófisis mastoides hasta la clavícula. Localización: El punto de entrada motor (PEM) se encuentra en el tercio superior (30-40% de la longitud del músculo). El punto motor intramuscular (PMI) y la zona de inervación (ZI) se localizan más centralmente, en el vientre muscular medio. Guía visual: Ilustración del músculo ECM. Se marca el PEM (X) en el tercio superior del músculo y el PMI (X) en el vientre muscular medio, a nivel del cartílago tiroides.",

  // TRONCO - Músculos mejorados y nuevos agregados
  "Erectores de la Columna (Lumbar)": "Región: Tronco. Puntos de Referencia: Apófisis espinosa de L4 y cresta ilíaca. Localización: Múltiples puntos. Un punto de referencia preciso se encuentra 2 cm lateral a la apófisis espinosa de L4 y 1 cm proximal a la cresta ilíaca. Guía visual: Imagen de la región lumbar. Se marcan las apófisis espinosas y la cresta ilíaca. Un punto (X) se sitúa según las coordenadas descritas, lateral a la columna.",
  "Recto del Abdomen": "Región: Tronco. Línea de Referencia: Desde la apófisis xifoides (0%) hasta la cresta del pubis (100%). Localización: Múltiples puntos al 10%, 30%, 50% y 75% de la longitud de la línea de referencia, a ambos lados de la línea alba. Guía visual: Ilustración de la pared abdominal anterior. Se dibuja la línea de referencia vertical. Se marcan pares de puntos (X) a cada lado de la línea alba en los porcentajes indicados.",

  "Abductor hallucis": "Región: Miembro Inferior. Se localiza en la región medial plantar del pie, justo distal al tubérculo del calcáneo. Para ubicarlo, palpa con el paciente en decúbito supino o sentado y solicita que realice una ligera flexión plantar y abducción del primer dedo; el punto de mínima resistencia a la estimulación eléctrica se encuentra aproximadamente en el punto medio entre el tubérculo calcáneo medial y la base de la primera falange proximal del hallux. Guía visual: Ilustración de la planta del pie. Se marca un punto (X) en el arco longitudinal interno.",
  "Adductor longus": "Región: Miembro Inferior. Se ubica en la cara medial del muslo. Con el paciente en decúbito supino, cadera en ligera abducción y rotación externa, palpa a aproximadamente 3 cm inferior a la sínfisis púbica y 2–3 cm medial a la línea media del muslo. La contracción se confirma solicitando aducción activa del muslo contra resistencia; el punto motor suele hallarse a nivel del tercio proximal del músculo, donde el nervio obturador ingresa al vientre muscular. Guía visual: Ilustración de la ingle. Se marca un punto (X) en la parte superior e interna del muslo.",
  ...
  "Biceps brachii": "Región: Miembro Superior. Se localiza a mitad del brazo, 6–8 cm distal al acromion. Cabeza corta (medial): al 69.0% de la distancia distal y 19.1% medial. Cabeza larga (lateral): al 67.3% de la distancia distal y 21.4% lateral. Guía visual: Ilustración del brazo anterior. Se marca un punto (X) en el centro del vientre muscular del bíceps.",
  ...
  "Cuadrado lumbar": "Región: Tronco. Con el paciente en decúbito lateral sobre el lado contralateral, flexiona ligeramente la rodilla para relajar la región lumbar. El punto motor se localiza en la región lumbar posterior, entre la cresta ilíaca y el ángulo inferior de la décima costilla, aproximadamente a 3–4 cm lateral a la apófisis espinosa de la cuarta vértebra lumbar (L4). La contracción se confirma solicitando elevación lateral de la pelvis contra resistencia. Guía visual: Ilustración de la región lumbar lateral. Se marca un punto (X) profundo entre el borde superior de la pelvis y las costillas inferiores.",
  "Deltoides": "Región: Miembro Superior. Se encuentra en el tercio medio del músculo, justo por debajo del acromion (aprox. 2 cm distal). Para las cabezas anterior y posterior, la zona óptima está en el tercio medio. Para la cabeza media, la zona se sitúa más distalmente. Guía visual: Ilustración de la vista lateral del hombro. Se marca un punto (X) en la parte más voluminosa del músculo.",
  ...
  "Gastrocnemio (cabeza lateral)": "Región: Miembro Inferior. Con el paciente en decúbito prono y rodilla en ligera flexión (20–30°), palpa la región posterolateral de la pantorrilla, aproximadamente 5–6 cm distal a la línea de pliegue poplíteo y lateral al tendón de Aquiles. Solicita flexión plantar contra resistencia; el punto motor está donde aparezca la contracción con la menor estimulación. Guía visual: Ilustración de la pantorrilla posterior. Se marca un punto (X) en el vientre muscular superior de la cabeza lateral.",
  "Gastrocnemio (cabeza medial)": "Región: Miembro Inferior. Con el paciente en decúbito prono y rodilla en ligera flexión, palpa la región posteromedial de la pantorrilla, aproximadamente 5–6 cm distal a la línea poplítea y medial al tendón de Aquiles. Solicita flexión plantar contra resistencia; el punto motor se localizará donde la contracción sea más intensa con bajo voltaje. Guía visual: Ilustración de la pantorrilla posterior. Se marca un punto (X) en el vientre muscular superior de la cabeza medial.",
  ...
  "Vastus lateralis, intermedius y medialis": "Región: Miembro Inferior. Esta entrada agrupa los tres vastos del cuádriceps. Vasto lateral: 10–12 cm proximal a la rótula (cara antero-lateral). Vasto medial: 8–10 cm proximal a la rótula (cara medial). Vasto intermedio: profundo, se estimula sobre el vasto lateral. Guía visual: Ilustración del muslo anterior. Se marcan puntos (X) en las porciones lateral, medial y central del cuádriceps.",

  // MÚSCULOS NUEVOS AGREGADOS - PIE Y OTROS IMPORTANTES
  "Flexor digitorum brevis": "Región: Miembro Inferior. Con el paciente en decúbito supino y rodilla flexionada, coloca el pie en posición neutra. Palpa en la región plantar media del pie, justo debajo de los metatarsos centrales (metatarsos 2–4). Solicita plantar flexión de los dedos menores contra resistencia; el punto motor se localiza donde la contracción se vea más marcada con la estimulación más baja. Guía visual: Ilustración de la planta del pie. Se marca un punto (X) en el centro de la almohadilla plantar.",

  // MÚSCULOS DEL MIEMBRO SUPERIOR ADICIONALES
  "Triceps brachii": "Región: Miembro Superior. En la región posterior del brazo, 6–8 cm proximal al olécranon. Cabeza larga: al 43.8% de la línea acromion-olécranon. Cabeza lateral: al 54.8%. Cabeza medial: al 60.4%. Guía visual: Ilustración del brazo posterior. Se marca un punto (X) en el centro del vientre muscular del tríceps.",
  "Flexor carpi radialis": "Región: Miembro Superior. En la cara volar-anterior del antebrazo, 7–8 cm distal al epicóndilo medial. El punto motor se localiza al 27% de la línea epicóndilo medial a base del 2º metacarpiano. Guía visual: Ilustración del antebrazo anterior. Se marca un punto (X) en el tercio proximal del músculo, en el lado radial.",
  "Extensor carpi radialis longus": "Región: Miembro Superior. En la región dorsal-anterolateral del antebrazo, 4–5 cm distal al epicóndilo lateral. El punto motor se localiza al 10% de la longitud del antebrazo. Guía visual: Ilustración del antebrazo posterior. Se marca un punto (X) muy proximalmente en el vientre muscular, en el lado radial.",
  "Supraespinoso": "Región: Miembro Superior. En la fosa supraespinosa de la escápula, a nivel del punto medio entre el acromion y el ángulo superior de la escápula. Solicita abducción inicial del hombro contra resistencia (primeros 15°); el punto motor se sitúa donde la contracción se aprecie con la menor corriente. Guía visual: Ilustración de la parte superior del hombro. Se marca un punto (X) en la escápula, por encima de su espina.",
  "Redondo menor": "Región: Miembro Superior. En la región posterior del hombro, 2–3 cm inferior al borde lateral de la espina de la escápula y lateral a la fosa infraespinosa. Solicita rotación externa de hombro contra resistencia; el punto motor se localiza donde la contracción sea más marcada con mínima estimulación. Guía visual: Ilustración de la parte posterior del hombro. Se marca un punto (X) en el borde lateral de la escápula, debajo de la espina.",

  // MÚSCULOS DEL MIEMBRO INFERIOR ADICIONALES
  "Biceps femoris": "Región: Miembro Inferior. En la cara posterior-lateral del muslo, a nivel del tercio medio, 6–8 cm distal a la tuberosidad isquiática. Los puntos motores se localizan entre el 35% y 50% de la longitud del músculo. Guía visual: Ilustración del muslo posterior. Se marca un punto (X) en el tercio medio del músculo, lado externo.",
  "Rectus femoris (cuádriceps anterior)": "Región: Miembro Inferior. En el vientre muscular del recto femoral, 10–12 cm proximal al borde superior de la rótula. Presenta dos puntos motores principales, al 40% y 60% de la línea EIAS-rótula. Guía visual: Ilustración del muslo anterior. Se marca un punto (X) en el centro del vientre muscular.",
  "Tibialis anterior": "Región: Miembro Inferior. En la cara anterior-lateral de la pierna, 7–8 cm proximal al maléolo medial. Un punto común se sitúa 1 cm lateral a un punto a un tercio de la línea tuberosidad tibial-maléolo medial. Guía visual: Ilustración de la pierna anterior. Se marca un punto (X) en el tercio proximal de la pierna, lateral a la cresta tibial.",
  "Extensor digitorum longus": "Región: Miembro Inferior. En la región anterolateral de la pierna, 8–10 cm proximal al maléolo lateral, justo lateral al peroné. Solicita dorsiflexión y extensión de dedos de los pies contra resistencia; el punto motor se encuentra donde la contracción sea máxima con mínima estimulación. Guía visual: Ilustración de la pierna anterolateral. Se marca un punto (X) en el tercio distal, al lado del peroné.",
  "Peroneus longus": "Región: Miembro Inferior. En la región lateral de la pierna, 8–10 cm proximal al maléolo lateral, justo anterior al peroné distal. Solicita eversión y plantar flexión del pie contra resistencia; el punto motor se halla donde la contracción se ve más potente al aplicar el menor voltaje. Guía visual: Ilustración de la pierna lateral. Se marca un punto (X) en la parte superior del grupo peroneo.",
  "Popliteus": "Región: Miembro Inferior. En la región poplítea, justo posterior al epicóndilo femoral lateral, entre la cabeza del gastrocnemio lateral y el bíceps femoral proximal. Solicita rotación interna de la tibia contra resistencia; el punto motor se localiza donde se observe contracción con mínimo voltaje. Guía visual: Ilustración de la parte posterior de la rodilla. Se marca un punto (X) en el hueco poplíteo, hacia el lado externo."
};
