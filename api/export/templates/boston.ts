...
export const BostonAssessmentSchema = z.object({
  patientData: z.object({
    name: z.string().optional(),
    age: z.string().optional(),
    gender: z.string().optional(),
    dominantHand: z.string().optional(),
    affectedHand: z.string().optional(),
    duration: z.string().optional(),
    doctorName: z.string().optional(),
  }),
  symptomsAnswers: z.record(z.number()),
  functionAnswers: z.record(z.number()),
  symptomsScore: z.number(),
  functionalScore: z.number(),
  symptomsInterpretation: z.string(),
  functionalInterpretation: z.string(),
  date: z.string().optional(),
});

export type BostonAssessment = z.infer<typeof BostonAssessmentSchema>;

export const generateHtml = (assessment: BostonAssessment): string => {
