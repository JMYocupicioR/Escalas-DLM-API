...
const BergAssessmentSchema = z.object({
...
const BergRequestSchema = z.object({
...
export type BergPayload = z.infer<typeof BergRequestSchema>;

export const generateHtml = (payload: BergPayload): string => {
