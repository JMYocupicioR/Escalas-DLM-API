...
const MocaAssessmentSchema = zod_1.z.object({
    patientData: zod_1.z.object({
        ...
        educationYears: zod_1.z.number().optional(),
    }),
    rawScore: zod_1.z.union([zod_1.z.number(), zod_1.z.string()]).optional(),
    adjustedScore: zod_1.z.union([zod_1.z.number(), zod_1.z.string()]).optional(),
    educationAdjustment: zod_1.z.number().optional(),
    interpretation: zod_1.z.object({
        level: zod_1.z.string(),
        description: zod_1.z.string(),
        recommendations: zod_1.z.string(),
        color: zod_1.z.string(),
    }).optional(),
    domainScores: zod_1.z.object({
        visoespacialEjecutiva: zod_1.z.number(),
        identificacion: zod_1.z.number(),
        atencion: zod_1.z.number(),
        lenguaje: zod_1.z.number(),
        abstraccion: zod_1.z.number(),
        recuerdoDiferido: zod_1.z.number(),
        orientacion: zod_1.z.number(),
    }).optional(),
    responses: zod_1.z.record(zod_1.z.number()).optional(),
});
const MocaRequestSchema = zod_1.z.object({
