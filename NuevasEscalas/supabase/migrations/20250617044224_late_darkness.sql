...
CREATE TABLE IF NOT EXISTS medical_scales (
    ...
    -- Search optimization - using regular column instead of generated
...
-- Function to update search vector for medical scales
...
CREATE TRIGGER update_medical_scales_search_vector
...
('last_key_rotation', '"2024-01-01T00:00:00Z"', 'Last time encryption keys were rotated'),
('data_retention_days', '2190', 'Number of days to retain audit logs (HIPAA compliance)'),
...
-- Insert Barthel question options
...
-- Arreglo personal
('10000000-0000-0000-0000-000000000004', 5, 'Independiente', 'Realiza todas las actividades personales sin ayuda alguna.', 1),
('10000000-0000-0000-0000-000000000004', 0, 'Dependiente', 'Necesita alguna ayuda para realizar el arreglo personal.', 2),

-- Deposición
('10000000-0000-0000-0000-000000000005', 10, 'Continente', 'No presenta episodios de incontinencia.', 1),
('10000000-0000-0000-0000-000000000005', 5, 'Accidente ocasional', 'Menos de una vez por semana o necesita ayuda para colocar enemas o supositorios.', 2),
('10000000-0000-0000-0000-000000000005', 0, 'Incontinente', 'Presenta más de un episodio semanal de incontinencia.', 3),

-- Micción
('10000000-0000-0000-0000-000000000006', 10, 'Continente', 'No presenta episodios de incontinencia en la micción.', 1),
('10000000-0000-0000-0000-000000000006', 5, 'Accidente ocasional', 'Un máximo de un episodio en 24 horas.', 2),
('10000000-0000-0000-0000-000000000006', 0, 'Incontinente', 'Presenta más de un episodio en 24 horas.', 3),

-- Retrete
('10000000-0000-0000-0000-000000000007', 10, 'Independiente', 'Entra y sale del retrete por sí solo sin requerir ayuda.', 1),
('10000000-0000-0000-0000-000000000007', 5, 'Necesita ayuda', 'Requiere una pequeña ayuda para acceder o utilizarlo.', 2),
('10000000-0000-0000-0000-000000000007', 0, 'Dependiente', 'Incapaz de acceder o utilizar el retrete sin asistencia mayor.', 3),

-- Transferencias
('10000000-0000-0000-0000-000000000008', 15, 'Independiente', 'No requiere ayuda para sentarse o levantarse de una silla o cama.', 1),
('10000000-0000-0000-0000-000000000008', 10, 'Mínima ayuda', 'Requiere supervisión o una pequeña ayuda física para transferirse.', 2),
('10000000-0000-0000-0000-000000000008', 5, 'Gran ayuda', 'Precisa ayuda de una persona fuerte para realizar la transferencia.', 3),
('10000000-0000-0000-0000-000000000008', 0, 'Dependiente', 'Necesita una grúa o la asistencia de dos personas para transferirse.', 4),

-- Deambulación
('10000000-0000-0000-0000-000000000009', 15, 'Independiente', 'Puede caminar 50 metros o su equivalente en el hogar sin ayuda.', 1),
('10000000-0000-0000-0000-000000000009', 10, 'Necesita ayuda', 'Requiere supervisión o una pequeña ayuda física para caminar.', 2),
('10000000-0000-0000-0000-000000000009', 5, 'Independiente en silla de ruedas', 'Puede desplazarse en silla de ruedas sin requerir ayuda ni supervisión.', 3),
('10000000-0000-0000-0000-000000000009', 0, 'Dependiente', 'Necesita asistencia para desplazarse.', 4),

-- Escaleras
('10000000-0000-0000-0000-000000000010', 10, 'Independiente', 'Capaz de subir y bajar un piso sin ayuda ni supervisión.', 1),
('10000000-0000-0000-0000-000000000010', 5, 'Necesita ayuda', 'Requiere asistencia o supervisión para subir y bajar escaleras.', 2),
('10000000-0000-0000-0000-000000000010', 0, 'Dependiente', 'Incapaz de subir escalones sin ayuda, requiere asistencia completa.', 3);
...
BEGIN
    PERFORM pg_notify('scale_updated', json_build_object(
        'scale_id', COALESCE(NEW.id, OLD.id),
        'action', TG_OP,
...
COMMENT ON FUNCTION update_scale_search_vector IS 'Updates the search vector for a medical scale when its content changes';